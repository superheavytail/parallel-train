...
export WANDB_NAME="solar-notinstruct-ko-en"
EPOCH=2
LR=5e-06
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node=8 finetune.py \
    ...
    --data_mixture "[kullm2_alpaca_gpt4, kullm2_xp3x_filtered_gpt4, kullm2_dolly_gpt4, kullm2_aya, koalpaca_v1_1, alpaca_gpt4]" \
    --vram_available "82GB" \
