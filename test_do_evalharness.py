...
setproctitle("potatowook lmevalharness")
model_kullm = "nlpai-lab/kullm-polyglot-12.8b-v2"
model_polyglot = "EleutherAI/polyglot-ko-12.8b"
model_kullm_improved = "/mnt/raid6/potatowook/kullm-enhance-ckpt/kullm-enhance1_3/checkpoint-3000"

# my_model = AutoModelForCausalLM.from_pretrained(model_kullm, torch_dtype=torch.float16, low_cpu_mem_usage=True)
...
if __name__ == "__main__":
    login("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")  # TODO harass
    cli_evaluate()
